...
class Program
{
    ...
    {
        // Implement logic for adding menu item
    ...
    {
        // Implement logic for updating menu item
    ...
    {
        // Implement logic for deleting menu item
    ...
    private static void SendDataToServer(CustomData data)
    {
        try
        {
            ...
            // Connect to server and send JSON data
            TcpClient client = new TcpClient(server, port);
            NetworkStream stream = client.GetStream();
...
public class CustomData
{
    ...
    public string Choice { get; set; } // Choice for menu action ("addMenuItem", "updateMenuItem", "deleteMenuItem")
    public MenuItem MenuItem { get; set; } // Additional details for menu actions
}
